...
/** Paiement (partiel ou total) d'une {@link CanteenInvoice}, saisi manuellement par le personnel. */
@Entity
@Table(name = "canteen_payments")
@Filter(name = "tenantFilter", condition = "school_id = :tenantId")
public class CanteenPayment extends TenantScopedEntity {
    ...
    protected CanteenPayment() {
    }

    public CanteenPayment(Long invoiceId, long amountCents, FeePaymentMethod method, String reference, Long recordedByUserId) {
