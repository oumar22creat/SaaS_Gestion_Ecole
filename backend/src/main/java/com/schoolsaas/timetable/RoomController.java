...
import com.schoolsaas.timetable.dto.RoomResponse;
...
public class RoomController {
    ...
    public ApiResponse<RoomResponse> create(@Valid @RequestBody RoomRequest request) {
        return ApiResponse.of(RoomResponse.from(roomService.create(request)));
    }
    ...
    public ApiResponse<RoomResponse> update(@PathVariable Long id, @Valid @RequestBody RoomRequest request) {
        return ApiResponse.of(RoomResponse.from(roomService.update(id, request)));
    }
